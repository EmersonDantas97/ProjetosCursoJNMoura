...
--2) Descreva o comando para listar todos os dados dos funcionários que tem salário
...
--7) Descreva o comando para listar os códigos de departamentos dos funcionários que tem
...
--12) Descreve o comando para lista os funcionários com sslários entre 1000 e 2000.
Select * 
From Funcionario 
Where Salario > 1000 
And Salario < 2000;
