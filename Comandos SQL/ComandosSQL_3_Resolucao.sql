...
--2) Descreva o comando para listar todos os dados dos funcionários que têm salário
--superior a R$ 1.000,00 ordenados por ordem decrescente de salário.
select * from Funcionario where Salario > 1000.00 order by Salario desc;

--3) Descreva o comando para listar o nome e o dia do aniversário dos funcionários que
--nasceram no mês de agosto ordenados por dia de aniversário.
select Concat(PrimeiroNome, ' ', isnull(SegundoNome,''), ' ', UltimoNome) as Nome, DataNascimento 
from Funcionario 
where Month(DataNascimento) = '08' 
order by Day(DataNascimento) desc;

--4) Descreva o comando para listar os nomes, endereços e fones dos funcionários que
--moram em Recife e que exerçam a função de Telefonista.
Select Concat(PrimeiroNome, ' ', isnull(SegundoNome,''), ' ', UltimoNome) as Nome, Endereco, Fone
From Funcionario 
Where Funcao = 'Telefonista'
and Cidade = 'Recife';

--5) Descreva o comando para listar os nomes dos funcionários que trabalham no
--departamento Pessoal (Código 3).
Select Concat(PrimeiroNome, ' ', Isnull(SegundoNome, ''), ' ', UltimoNome) as Nome
From Funcionario
Where CodigoDepartamento = 3;

--6) Descreva o comando para listar o nome, o código do departamento e a função de todos
--os funcionários.
Select Concat(PrimeiroNome, ' ', isnull(SegundoNome,''), ' ', UltimoNome) as Nome, CodigoDepartamento, Funcao
From Funcionario;

--7) Descreva o comando para listar os códigos de departamentos dos funcionários que têm
...
Select count(*) as QtdFuncionarios
From Funcionario;
...
--10) Descreva o comando para listar a quantidade de funcionários por departamento
--ordenados por ordem decrescente de quantidade de funcionários.
Select CodigoDepartamento, Count(CodigoDepartamento) as QtdPorDepartamento
From Funcionario 
Group by CodigoDepartamento 
Order by QtdPorDepartamento Desc;

--11) Descreva o comando para listar o nome de todos os funcionários que não tenham
--segundo nome.
Select PrimeiroNome 
from Funcionario 
Where SegundoNome is NULL;

--12) Descreve o comando para lista os funcionários com salários entre 1000 e 2000.
Select * 
From Funcionario 
Where Salario > 1000 
And Salario < 2000;

--13) Descreva o comando para listar os nomes dos funcionários que tenham a primeira letra
--igual a “C”.
Select * 
From Funcionario 
Where PrimeiroNome like 'C%';

--14) Descreva o comando para listar os códigos de departamentos que possuem funcionários
--sem repetição.
Select CodigoDepartamento 
From Funcionario
Group by CodigoDepartamento;
...
--17) Descreva o comando para inserir o funcionário com os seguintes dados:
insert into Funcionario (CodigoDepartamento,PrimeiroNome,SegundoNome,UltimoNome,DataNascimento,CPF,RG,Endereco,CEP,Cidade,Fone,Funcao,Salario)
